...
const buttonVariants = cva(
    ...
    "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground dark:text-white shadow-lg hover:bg-primary/90 hover:shadow-xl focus:ring-2 focus:ring-primary/30 focus:ring-offset-2",
        destructive:
      ...
      size: {
        ...
        lg: "h-12 rounded-md px-6 has-[>svg]:px-4 text-base font-semibold",
