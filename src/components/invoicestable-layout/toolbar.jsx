                    ...
                    >
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-medium">
                                {noOfInvoicesSelected} invoice{noOfInvoicesSelected > 1 ? "s" : ""} selected
                            </span>
                        </div>
                        ...
                        <div className="flex items-center gap-1">
                            <Tooltip>
                                ...
                                <TooltipContent>
                                    <p>Download selected invoices</p>
                                </TooltipContent>
                            </Tooltip>
                    ...
                    <div className="w-20 flex items-center gap-1.5 bg-transparent rounded-2xl border border-gray-300 dark:border-gray-700">
                        <button
                            className={cn(
                                ...
                                layoutView === LAYOUT_VIEW.GRID && "bg-primary text-white"
                            )}
                            onClick={() => handleLayoutView(LAYOUT_VIEW.GRID)}
                        >
                        ...
                        <button
                            className={cn(
                                ...
                                layoutView === LAYOUT_VIEW.LIST && "bg-primary text-white"
                            )}
                            onClick={() => handleLayoutView(LAYOUT_VIEW.LIST)}
                        >
