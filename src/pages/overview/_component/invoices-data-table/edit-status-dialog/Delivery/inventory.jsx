...
export default function DeliveryInventory({ data }) {
    ...
    return (
        <section className="flex flex-row justify-between items-center mb-2 gap-x-2 w-full">
            <div className="flex items-center">
                ...
                <Label className="ml-2">{invoice?.items}</Label>
            </div>
            ...
            <div className="flex items-center">
                ...
                <Input
                    ...
                    defaultValue = {invoice?.totalWeightKg}
                />
            </div>
            {/* <div className='border-l border-gray-800 h-6 self-center'></div> */}
            <div className="flex items-center">
                <Label className="text-xs">No of Packages:</Label>
                <Input type="number" className="w-18 ml-2 h-6" value={invoice?.totalPackages}/>
            </div>
        </section>
    )
}
